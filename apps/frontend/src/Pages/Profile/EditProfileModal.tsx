...
export default function EditProfileModal({open, userId, userProfile, onClose}: Props) {
  const revalidator = useRevalidator();

  const [formState, setFormState] = useState<Partial<UpdateProfileData>>({ ...userProfile });
